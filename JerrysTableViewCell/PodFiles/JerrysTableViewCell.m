...
@interface JerrysTableViewCell () <UIScrollViewDelegate,  UIGestureRecognizerDelegate>

@property (nonatomic, weak) UITableView *containingTableView;

@property (nonatomic, strong) UIPanGestureRecognizer *tableViewPanGestureRecognizer;

@property (nonatomic, assign) JerrysCellState cellState; // The state of the cell within the scroll view, can be left, right or middle
@property (nonatomic, assign) CGFloat additionalRightPadding;

@property (nonatomic, strong) UIScrollView *cellScrollView;
@property (nonatomic, strong) JerrysUtilityButtonView *leftUtilityButtonsView, *rightUtilityButtonsView;
...
- (CGPoint)contentOffsetForCellState:(JerrysCellState)state;
...
@implementation JerrysTableViewCell {
...
- (void)initializer
{
    ...
    self.cellScrollView = [[JerrysCellScrollView alloc] init];
    ...
    self.longPressGestureRecognizer = [[JerrysLongPressGestureRecognizer alloc] initWithTarget:self action:@selector(scrollViewPressed:)];
    ...
    self.leftUtilityButtonsView = [[JerrysUtilityButtonView alloc] initWithUtilityButtons:nil
                                                                           parentCell:self
    ...
    self.rightUtilityButtonsView = [[JerrysUtilityButtonView alloc] initWithUtilityButtons:nil
                                                                            parentCell:self
...
{
    JerrysUtilityButtonTapGestureRecognizer *utilityButtonTapGestureRecognizer = (JerrysUtilityButtonTapGestureRecognizer *)sender;
...
- (void)updateCellState
{
    ...
    {
        JerrysCellState cellState = numState.integerValue;
...
- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset
{
    ...
    if (_cellState != kCellStateCenter)
    {
        if ([self.delegate respondsToSelector:@selector(swipeableTableViewCellShouldHideUtilityButtonsOnSwipe:)])
        {
            for (JerrysTableViewCell *cell in [self.containingTableView visibleCells]) {
                if (cell != self && [cell isKindOfClass:[JerrysTableViewCell class]] && [self.delegate swipeableTableViewCellShouldHideUtilityButtonsOnSwipe:cell]) {
